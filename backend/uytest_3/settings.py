"""
Django settings for uytest_3 project.
...
WSGI_APPLICATION = "uytest_3.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "uytest_3 API",
    "DESCRIPTION": "API documentation for uytest_3 App",
    "VERSION": "v1",
}
